...
1. Download the pre-built AAR from the [releases page](https://github.com/aryan447/mpvlib/releases)
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/aryan447/mpv-lib/blob/main/LICENSE) file for details.
